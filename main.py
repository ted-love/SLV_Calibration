...
def Douglas_Scheme(m, m1, m2, r_d, r_f, N, P0, S_0, Leverage_function, Delta_T, alpha, D_x, D_xx, D_v, D_vv, T_vec, X_vec, V_vec, w_x, w_v, local_vol_interp, rho, sigma, kappa, theta):
    """
...
def main():
    ...
    P, Leverage_function = Douglas_Scheme(m, m1, m2, r_d, r_f, N, P_0, S_0, Leverage_function, Delta_T, alpha, D_x, D_xx, D_v, D_vv, T_vec, X_vec, V_vec, w_x, w_v, local_vol_interpolation, rho, sigma, kappa, theta)
